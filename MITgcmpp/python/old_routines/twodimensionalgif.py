...
def twodimensionalgif (gif_args):
	...
	for m in iter_range:
		...
		if plot_type == None:
			pplot.pcolormesh(x_axis_data,y_axis_data,masked,vmin=gif_args['vmin'],vmax=gif_args['vmax'],cmap=cmap)
			print("plot_type = None")
			...
			pplot.pcolormesh(x_axis_data,y_axis_data,masked,vmin=gif_args['vmin'],vmax=gif_args['vmax'],cmap=cmap,shading='gouraud')
			# ensure origin is in lower left corner
			pplot.ylim(min(pplot.ylim()), max(pplot.ylim()))
			# add titles and axis labels
			pplot.title(plot_title)
			...
			#plot data
			im = ax.imshow(masked,cmap=cmap,interpolation=interp_type,extent=[x_axis_min,x_axis_max,y_axis_min,y_axis_max],aspect='auto',origin=origin_val)
			# add titles and axis labels
			pplot.title(plot_title)
			pplot.xlabel(x_axis_label)
			pplot.ylabel(y_axis_label)
			...
			pplot.contourf(x_axis_data,y_axis_data,masked,contour_max,cmap=cmap)
			print("plot_type = None")
			# add titles and axis labels
			pplot.title(plot_title)
			pplot.xlabel(x_axis_label)
